...
/**
 *  Insert in context List Music Library Songs
 *
...
-(void)populateMusicDataInContext:(NSManagedObjectContext *)context completion:(void(^)())completion
{
    [context performBlock:^{
        ...
        for (MPMediaItem *item in mediaList) {
            ...
            song.songAlbum = [item valueForProperty: MPMediaItemPropertyArtist];
            song.songGenre = [item valueForProperty: MPMediaItemPropertyGenre];
            song.songDuration= [item valueForProperty: MPMediaItemPropertyPlaybackDuration];
            ...
            song.songArtworkImage = artWorkData;
